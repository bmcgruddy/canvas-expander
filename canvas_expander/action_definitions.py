...
if _krita_module:
    ...
    from .operators import (
        SelectorByActiveLayerColorFunction as _operator_active_selector,
    )
    ...
    from .operators import (
        LayerCycleByActiveLayerColorFunction as _operator_active_cycle,
    )
    from .operators import (
        LayerIsolateByActiveLayerColorFunction as _operator_active_isolate,
    )
    from .operators import (
        LayerToggleByActiveLayerColorFunction as _operator_active_toggle,
    )
        ...
        def _function_constructor(operator, *args, **kwargs):
            def _function():
                ...
                view.showFloatingMessage(
                    _notification_message, self.iconLoaded, 1000, 1
                )
...
def BuildSortedActions():
    ...
    for _action in BuildActionInstances():
        _sorted_actions = {
            **_sorted_actions,
            _action.categoryName: [
                *_sorted_actions.get(_action.categoryName, []),
                _action,
            ],
        }
